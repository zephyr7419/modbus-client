...
//
//        changeCheck(currentDiCoilValues, previousDiCoilValues);
//
//        changeCheck(currentDoCoilValues, previousDoCoilValues);
//    }
//
//    private void changeCheck(BitVector currentDoCoilValues, BitVector previousDoCoilValues) {
...
//        values.add(hzSv);
//        if (fanOn == 0) {
//            tcp6266.writeCoilValues(false);
//            values.add(0x0000);
//        } else {
//            fanOn = 0x1000;
//            tcp6266.writeCoilValues(true);
//            values.add(fanOn);
//        }
//
//        for (int v : values) {
...
//    }
//
//    public void writeResponseParsing(byte[] data, ChannelHandlerContext ctx) {
//        ParseAndResponse parseAndResponse = new ParseAndResponse();
